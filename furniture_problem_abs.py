...
# =============================================================================
# absolute value of table and chair should be <= 5
# =============================================================================

diff_raw_table_chair = model.addVar(lb=-GRB.INFINITY)
diff_abs_table_chair = model.addVar()

model.addConstr(diff_raw_table_chair == make["table"] - make["chair"])
model.addConstr(diff_abs_table_chair == gp.abs_(diff_raw_table_chair))
model.addConstr(diff_abs_table_chair <= 5)
